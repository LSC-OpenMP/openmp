...
void *__tgt_rtl_data_alloc(int32_t device_id, int64_t size, void *hst_ptr, int64_t type) {
...
int32_t __tgt_rtl_run_target_team_region(int32_t device_id, void *tgt_entry_ptr,
    void **tgt_args, ptrdiff_t *tgt_offsets, int64_t *tgt_sizes, int32_t arg_num, int32_t team_num,
...
int32_t __tgt_rtl_run_target_region(int32_t device_id, void *tgt_entry_ptr,
    void **tgt_args, ptrdiff_t *tgt_offsets, int64_t *tgt_sizes, int32_t arg_num) {
  // use one team and one thread.
  return __tgt_rtl_run_target_team_region(device_id, tgt_entry_ptr, tgt_args,
      tgt_offsets, tgt_sizes, arg_num, 1, 1, 0);
}
